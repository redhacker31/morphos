...
import { Wand2, Users, RefreshCcw, MessageSquare, Database, Shield } from "lucide-react";
const features = [{
  icon: Wand2,
  ...
  return <section id="features" className="py-24 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        margin: "-50px"
          ...
          {features.map(feature => <motion.div key={feature.title} variants={cardVariants} className="glass group p-8 hover:border-[var(--card-border-hover)] transition-all duration-300 hover:-translate-y-1 bg-[#E4E7E60A] shadow-[0px_4px_16px_0px_#F3F2F2FF]">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-6 border border-[var(--card-border)] transition-all duration-300 group-hover:shadow-lg" style={{
