        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            <div className="flex items-center gap-3 border-b border-red-500/20 pb-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-[var(--text-primary)]">Traditional LLM Code Generation</h3>
                <p className="text-xs text-red-500">Generates raw JSX / HTML / JavaScript strings</p>
              </div>
            </div>
          ...
          >
            ...
            <div className="flex items-center gap-3 border-b border-[var(--card-border)] pb-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-[var(--text-primary)]">MorphOS JSON AST Platform</h3>
