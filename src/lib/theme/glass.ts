export const glassStyles = {
  card: "bg-card backdrop-blur-xl border border-glass-border shadow-glass relative overflow-hidden",
  panel: "bg-surface/80 backdrop-blur-2xl border border-border shadow-large",
  sidebar: "bg-surface-elevated/70 backdrop-blur-3xl border-r border-border shadow-medium",
  navbar: "bg-background/60 backdrop-blur-xl border-b border-border z-sticky",
