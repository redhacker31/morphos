  ...
  return (
    <div className="space-y-1.5 w-full">
      ...
      <textarea
        ...
        className="w-full bg-[var(--hover-overlay)] border border-[var(--card-border)] rounded-xl px-3 py-2 text-xs text-[var(--text-primary)] placeholder-[var(--text-muted)] focus:outline-none focus:border-[var(--primary)] resize-none"
      />
    </div>
  );
});
