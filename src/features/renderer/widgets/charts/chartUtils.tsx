...
export const CHART_TICK = "#a1a1aa"; // --text-secondary
export const CHART_GRID = "rgba(255,255,255,0.06)";
export const CHART_CURSOR = "rgba(255,255,255,0.05)";
export const CHART_SURFACE = "#14141c"; // --surface-elevated
...
export function ChartTooltip({ active, payload, label }: ChartTooltipProps) {
  ...
  return (
    <div className="rounded-xl border border-[var(--card-border)] bg-[var(--surface-elevated)]/95 backdrop-blur-xl px-3 py-2 shadow-elev-3">
      {label != null && label !== "" && (
