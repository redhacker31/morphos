...
export const WidgetFactory = memo(function WidgetFactory({
  ...
  if (!entry) {
    return (
      <div className="w-full h-full rounded-2xl bg-amber-500/10 border border-amber-500/30 p-5 space-y-2 backdrop-blur-xl text-amber-300 text-xs flex flex-col justify-center items-center text-center">
