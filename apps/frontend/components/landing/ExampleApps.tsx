...
const EXAMPLE_APPS = [
  {
    ...
    metrics: [
      { label: "Active Pipeline", value: "$4.2M" },
      { label: "Win Rate", value: "34.8%" },
  ...
  },
  {
    ...
    metrics: [
      { label: "Monthly Runway", value: "24 Mos" },
      { label: "OpEx Efficiency", value: "+14.2%" },
      { label: "Gross Margin", value: "78.4%" },
    ],
  ...
  },
  {
    ...
    metrics: [
      { label: "Active SKUs", value: "14,280" },
      { label: "Fulfillment SLA", value: "99.4%" },
      { label: "Stockout Risk", value: "0.2%" },
    ],
  ...
  },
  {
    ...
    metrics: [
      { label: "Bed Occupancy", value: "88.2%" },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-5 space-y-6">
                <div className="space-y-2">
                  <span
                    className="text-xs font-extrabold uppercase tracking-wider px-3 py-1 rounded-md"
                    style={{
                  ...
                  <div className="grid grid-cols-12 gap-3 min-h-[260px]">
                    <div className="col-span-8 rounded-xl bg-white/[0.04] border border-white/10 p-4 space-y-3 flex flex-col justify-between">
                      ...
                      <div className="h-28 w-full rounded-lg bg-gradient-to-t from-[var(--primary)]/20 to-transparent border-b border-[var(--primary)]/40 relative flex items-end justify-between px-4 pb-2">
                        {[40, 65, 55, 80, 95, 70, 85].map((h, idx) => (
                          <div
                            key={idx}
                            className="w-4 rounded-t bg-gradient-to-t from-[var(--primary)] to-[var(--secondary)]"
                            style={{ height: `${h}%` }}
                          />
                        ))}
                      </div>
