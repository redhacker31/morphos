...
export function EmptyWorkspace({ onSelectTemplate, onFocusPrompt }: EmptyWorkspaceProps) {
  return (
    <div className="w-full max-w-4xl mx-auto space-y-10 py-6">
      {/* Welcome Hero Banner */}
      <div className="rounded-3xl bg-gradient-to-br from-[var(--surface-elevated)] via-[var(--surface)] to-black border border-white/10 p-8 text-center space-y-4 relative overflow-hidden shadow-2xl">
        <motion.div
          animate={{ scale: [1, 1.05, 1] }}
          transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
          className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[var(--primary)]/30 to-[var(--accent)]/30 border border-white/15 mx-auto flex items-center justify-center shadow-[0_0_30px_var(--primary-glow)]"
        >
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6 space-y-4">
          ...
          <div className="space-y-2.5 text-xs text-[var(--text-secondary)]">
            <div className="flex items-center justify-between p-2 rounded-lg bg-white/5 border border-white/5">
              ...
              <kbd className="px-2 py-0.5 rounded bg-white/10 font-mono text-[10px] text-white">⌘K / Ctrl+K</kbd>
            </div>
            <div className="flex items-center justify-between p-2 rounded-lg bg-white/5 border border-white/5">
              <span>Focus Main Prompt Studio</span>
              <kbd className="px-2 py-0.5 rounded bg-white/10 font-mono text-[10px] text-white">/</kbd>
            </div>
            <div className="flex items-center justify-between p-2 rounded-lg bg-white/5 border border-white/5">
            ...
            <div className="flex items-center justify-between p-2 rounded-lg bg-white/5 border border-white/5">
              ...
              <kbd className="px-2 py-0.5 rounded bg-white/10 font-mono text-[10px] text-white">Ctrl + Enter</kbd>
            </div>
          </div>
        </div>
